...
module AWS.WAFRegional.XssMatchSet
    ( FieldToMatch(..)
    , XssMatchTuple(..)
    , XssMatchSet(..)
    , resourceJSON
...
data XssMatchSet = XssMatchSet
    { _XssMatchSetXssMatchTuples :: Maybe [XssMatchTuple]
...
resourceJSON a = DA.object [ "Type" .= ("AWS::WAFRegional::XssMatchSet" :: Text), "Properties" .= a ]
